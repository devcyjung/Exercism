...
func Search(pattern string, flags, files []string) []string {
    ...
    if err != nil {
        logger.Error("Regex construction failed", "error", err, "pattern", pattern, "match options", matchOpt)
        return nil
    }
...
func matchResult(files []string, lineMatcher *matcher, lineWriter writer, oneMatchPerFile bool) []string {
