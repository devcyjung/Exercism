...
def decode(ciphered_text):
    decoded = ciphered_text.translate(_decoding)
    if any(ch not in ascii_lowercase + digits for ch in decoded):
        raise ValueError(f'Cipher {ciphered_text} contains invalid character')
    return decoded
