...
def check_drinks(drink_name, drink_ingredients):
    ...
    category = 'C' if any((ingredient in ALCOHOLS for ingredient in drink_ingredients)) else 'M'
...
def categorize_dish(dish_name, dish_ingredients):
    ...
    return f'{dish_name}: {next((name for name, variable in globals().items() if variable is category))}'
