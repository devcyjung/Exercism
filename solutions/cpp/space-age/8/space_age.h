...
public:
    ...
    [[nodiscard]]
    inline long long int seconds(void) const noexcept
    {
        return seconds_;
    }

    [[nodiscard]]
    inline double on_mercury(void) const noexcept
    {
        return earth_age_ / mercury_year;
    }

    [[nodiscard]]
    inline double on_venus(void) const noexcept
    {
        return earth_age_ / venus_year;
    }

    [[nodiscard]]
    inline double on_earth(void) const noexcept
    {
        return earth_age_;
    }

    [[nodiscard]]
    inline double on_mars(void) const noexcept
    {
        return earth_age_ / mars_year;
    }

    [[nodiscard]]
    inline double on_jupiter(void) const noexcept
    {
        return earth_age_ / jupiter_year;
    }

    [[nodiscard]]
    inline double on_saturn(void) const noexcept
    {
        return earth_age_ / saturn_year;
    }

    [[nodiscard]]
    inline double on_uranus(void) const noexcept
    {
