...
public:
    ...
    inline constexpr long long int seconds(void) const {
        return seconds_;
    }
    inline constexpr double on_mercury(void) const {
        return earth_age_ / mercury_year;
    }
    inline constexpr double on_venus(void) const {
        return earth_age_ / venus_year;
    }
    inline constexpr double on_earth(void) const {
        return earth_age_;
    }
    inline constexpr double on_mars(void) const {
        return earth_age_ / mars_year;
    }
    inline constexpr double on_jupiter(void) const {
        return earth_age_ / jupiter_year;
    }
    inline constexpr double on_saturn(void) const {
        return earth_age_ / saturn_year;
    }
    inline constexpr double on_uranus(void) const {
        return earth_age_ / uranus_year;
    }
    inline constexpr double on_neptune(void) const {
