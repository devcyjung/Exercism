public class WeatherStation
{
    ...
    public Outlook LongTermOutlook => reading.Direction switch
    {
...
public readonly record struct Reading(decimal Temperature, decimal Pressure, decimal Rainfall, WindDirection Direction);
