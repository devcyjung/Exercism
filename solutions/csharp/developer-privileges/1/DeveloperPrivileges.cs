...
{
    private static readonly Identity admin = new("admin@ex.ism", new("green", 0.9m), new string[]{"Chanakya", "Mumbai", "India"}); 
    
    public Identity Admin => admin;

    private static readonly Dictionary<string, Identity> devs = new()
    {
        ["Bertrand"] = new("bert@ex.ism", new("blue", 0.8m), new string[]{"Bertrand", "Paris", "France"}),
        ["Anders"] = new("anders@ex.ism", new("brown", 0.85m), new string[]{"Anders", "Redmond", "USA"}),
    };
